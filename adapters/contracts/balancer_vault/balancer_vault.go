...
func bindBalancerVault(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := BalancerVaultMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
func (_BalancerVault *BalancerVaultCaller) GetNextNonce(opts *bind.CallOpts, account common.Address) (*big.Int, error) {
	var out []interface{}
	err := _BalancerVault.contract.Call(opts, &out, "getNextNonce", account)
...
//
// Solidity: function getNextNonce(address account) view returns(uint256)
func (_BalancerVault *BalancerVaultSession) GetNextNonce(account common.Address) (*big.Int, error) {
	return _BalancerVault.Contract.GetNextNonce(&_BalancerVault.CallOpts, account)
}

// GetNextNonce is a free data retrieval call binding the contract method 0x90193b7c.
//
// Solidity: function getNextNonce(address account) view returns(uint256)
func (_BalancerVault *BalancerVaultCallerSession) GetNextNonce(account common.Address) (*big.Int, error) {
	return _BalancerVault.Contract.GetNextNonce(&_BalancerVault.CallOpts, account)
}
